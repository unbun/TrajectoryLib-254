	...
	public static void main(String[] args) {
		 ...
		 */
		{
			...
			if (!writeFile(fullpath, serialized)) {
				System.err.println(fullpath + " could not be written!!!! Line 96");
				System.exit(1);
			} else {
...

		{
			...
			String fullpath = joinPath(directory, path_name + ".txt");
			if (!writeFile(fullpath, serialized)) {
				System.err.println(fullpath + " could not be written!!!!Line 127");
				System.exit(1);
			} else {
				System.out.println("Wrote " + fullpath);
			}
...

		{
			...
			String fullpath = joinPath(directory, path_name + ".txt");
			if (!writeFile(fullpath, serialized)) {
				System.err.println(fullpath + " could not be written!!!!156");
				System.exit(1);
			} else {
				System.out.println("Wrote " + fullpath);
			}
...

		{
			...
			String fullpath = joinPath(directory, path_name + ".txt");
			if (!writeFile(fullpath, serialized)) {
				System.err.println(fullpath + " could not be written!!!!189");
				System.exit(1);
			} else {
				System.out.println("Wrote " + fullpath);
			}
...

		{
			...
			String fullpath = joinPath(directory, path_name + ".txt");
			if (!writeFile(fullpath, serialized)) {
				System.err.println(fullpath + " could not be written!!!!222");
				System.exit(1);
			} else {
				System.out.println("Wrote " + fullpath);
				System.out.println("Last Path Reticulated");
